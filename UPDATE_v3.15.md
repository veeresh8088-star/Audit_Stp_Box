# AICyberAuditBox v3.15 - Delta Update (app)

## What's in this delivery
  1. aicyberauditbox_delta_app_v3.15.tar          -- Only the rebuilt image(s): app
  2. aicyberauditbox_delta_app_v3.15_companion.zip -- This guide + updated docker-compose.customer.yml
...
## Apply this update
  ...
  Step 1 - Load only the new image(s):
    docker load -i aicyberauditbox_delta_app_v3.15.tar
