# AICyberAuditBox v3.8 - Customer Quickstart

## What's in your delivery
You received two files:
  1. aicyberauditbox_bundle_v3.8.tar      -- All Docker images (~7 GB, air-gapped)
  2. aicyberauditbox_bundle_v3.8_companion.zip -- This guide + docker-compose.customer.yml
...
## Deploy (offline / air-gapped)
  ...
  Step 1 - Load all images (one-time, no internet needed):
    docker load -i aicyberauditbox_bundle_v3.8.tar
...
## Included images
- aicyberauditbox-shakthidb:2.1
- aicyberauditbox-llm:2.2
- aicyberauditbox-llm-embed:2.2
- aicyberauditbox-app:3.8
- redis:7-alpine
