...
class CompPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 8, 'AICyberAuditBox - React vs. Vanilla JS Architecture Comparison', align='R', new_x=XPos.LMARGIN, new_y=YPos.NEXT)
...
def clean(val):
    ...
    val = val.replace('📊', '[COMP]').replace('💡', '[NOTE]')
...
def generate_pdf():
    ...
    md_file = 'React_vs_VanillaJS_Comparison_Report.md'
    ...
    print(f"[SUCCESS] Comparison PDF generated successfully: {output_pdf}")
