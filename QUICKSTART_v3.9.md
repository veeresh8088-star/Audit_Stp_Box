# AICyberAuditBox v3.9 - Customer Quickstart

## What's in your delivery
You received two files:
  1. aicyberauditbox_bundle_v3.9.tar      -- All Docker images (~7 GB, air-gapped)
  2. aicyberauditbox_bundle_v3.9_companion.zip -- This guide + docker-compose.customer.yml
...
## Deploy (offline / air-gapped)
  ...
  Step 1 - Load all images (one-time, no internet needed):
    docker load -i aicyberauditbox_bundle_v3.9.tar
